export default class Githubcorner {
  constructor(holder) {
    this.holder = holder;
    this.init();
  }
  init() {
    this.holder.insertAdjacentHTML(
      "beforeend",
      `<a href="https://github.com/Bjorn1973/datetime_app" target="blank" class="github-corner" aria-label="View source on GitHub">
      <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#0000b3; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
